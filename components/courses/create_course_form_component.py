...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.title_input = Input(page,
                                 'create-course-form-title-input', "Title")
    ...
    @allure.step(
        'Fill create course form with values: "{title}", "{estimated_time}", '
        '"{description}", "{max_score}", "{min_score}"')
    def fill(
            self,
            title: str,
            estimated_time: str,
    ...
    @allure.step(
        'Check visible course form values: "{title}", "{estimated_time}", '
        '"{description}", "{max_score}", "{min_score}"')
    def check_visible(
            self,
            title: str,
