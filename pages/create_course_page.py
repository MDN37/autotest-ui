...
from components.views.empty_view_component import (
    EmptyViewComponent)
...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        self.exercises_empty_view = EmptyViewComponent(
            page, 'create-course-exercises')
        self.create_course_form = CreateCourseFormComponent(page)
        self.create_course_toolbar_view = CreateCourseToolbarViewComponent(
            page)
    ...
    def check_visible_exercises_empty_view(self):
        self.exercises_empty_view.check_visible(
            ...
            description='Click on "Create exercise" '
