from components.charts.chart_view_component import (
    ChartViewComponent)
from components.dashboard.dashboard_toolbar_view_component import (
    DashboardToolbarViewComponent)
from components.navigation.navbar_component import (
    NavbarComponent)
from components.navigation.sidebar_component import (
    SidebarComponent)
...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.activities_chart_view = ChartViewComponent(
            page, "activities", "line")
