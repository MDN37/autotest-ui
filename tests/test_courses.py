...
def test_empty_courses_list(chromium_page_with_state: Page):
    ...
    empty_block = chromium_page_with_state.get_by_test_id(
        "courses-list-empty-view-icon")
    expect(empty_block).to_be_visible()

    results_block = chromium_page_with_state.get_by_test_id(
        "courses-list-empty-view-title-text")
    expect(results_block).to_have_text("There is no results")

    description_text = chromium_page_with_state.get_by_test_id(
